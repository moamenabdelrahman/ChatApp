...
namespace Domain.UseCases
{
    public class JoinGroupUseCase
    {
        ...
        public JoinGroupUseCase(IUserRepository userRepository,
        ...
        public async Task<Result> Handle(string userName, int groupId)
        {
            ...
            if (group.Type != Enums.ChatType.Group)
                return Result.Fail("You can't join a private chat!");

            var result = await _chatRepository.AddToGroup(user, group);
